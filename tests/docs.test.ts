...
describe('documentation contract', () => {
  ...
  it('ships focused reference docs for install, collect, round2, gotchas, and runbook guidance', () => {
    ...
    expectContainsAll(round2Reference, [
      ...
      'report-from-round2.mjs',
      'the agent still owns the keep/reject judgment',
    ...
    expectContainsAll(gotchasReference, [
      ...
      'open-source project keywords can look like brand or repo navigation queries',
      '`pascal editor` was a real example of this failure mode',
      'over-automation can create false confidence',
    ]);
